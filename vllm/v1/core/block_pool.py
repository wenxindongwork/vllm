...
class BlockPool:
    ...
    def get_usage(self, preferred_device: Optional[int] = None) -> float:
        ...
        if preferred_device is None:
            ...
            return 1.0  - sum(self.get_num_free_blocks(i) for i in range(self.dp_size))/self.num_gpu_blocks
        return 1.0 - (self.get_num_free_blocks(preferred_device) / self.num_gpu_blocks)
